...
const routerSwap_1 = require("./routerSwap");
...
Object.defineProperty(exports, "IDexType", { enumerable: true, get: function () { return interfaces_1.IDexType; } });
const dexPair_1 = require("./dexPair");
...
async function getDexPairReserves(chainId, dexCode, pairAddress, tokenInAddress, tokenOutAddress) {
    ...
    const wallet = eth_wallet_1.RpcWallet.getRpcWallet(chainId);
    ...
    return [
        {
            dexCode: 'UniswapV2',
            dexName: 'UniswapV2',
            dexType: interfaces_1.IDexType.Normal,
            details: [
                {
                    chainId: 1,
        ...
        },
        {
            dexCode: 'IFSwapV3',
            dexName: 'IFSwapV3',
            dexType: interfaces_1.IDexType.IFSwapV3,
            details: [
                {
                    chainId: 56,
        ...
        },
        {
            dexCode: 'BakerySwap',
            dexName: 'BakerySwap',
            dexType: interfaces_1.IDexType.BakerySwap,
            details: [
                {
                    chainId: 56,
        ...
        },
        {
            dexCode: 'TraderJoe',
            dexName: 'TraderJoe',
            dexType: interfaces_1.IDexType.TraderJoe,
            details: [
                {
                    chainId: 43114,
